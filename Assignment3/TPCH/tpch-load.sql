...
COPY region FROM '/Users/amol/newsvn/misc-work/724-spring2011/assignments/TPCH/tables/region.tbl' WITH DELIMITER AS '|';
COPY nation FROM '/Users/amol/newsvn/misc-work/724-spring2011/assignments/TPCH/tables/nation.tbl' WITH DELIMITER AS '|';
COPY part FROM '/Users/amol/newsvn/misc-work/724-spring2011/assignments/TPCH/tables/part.tbl' WITH DELIMITER AS '|';
COPY supplier FROM '/Users/amol/newsvn/misc-work/724-spring2011/assignments/TPCH/tables/supplier.tbl' WITH DELIMITER AS '|';
COPY partsupp FROM '/Users/amol/newsvn/misc-work/724-spring2011/assignments/TPCH/tables/partsupp.tbl' WITH DELIMITER AS '|';
COPY customer FROM '/Users/amol/newsvn/misc-work/724-spring2011/assignments/TPCH/tables/customer.tbl' WITH DELIMITER AS '|';
COPY orders FROM '/Users/amol/newsvn/misc-work/724-spring2011/assignments/TPCH/tables/orders.tbl' WITH DELIMITER AS '|';
COPY lineitem FROM '/Users/amol/newsvn/misc-work/724-spring2011/assignments/TPCH/tables/lineitem.tbl' WITH DELIMITER AS '|';
